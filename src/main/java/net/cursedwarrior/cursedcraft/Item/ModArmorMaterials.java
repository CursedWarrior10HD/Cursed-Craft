...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    STEEL("steel", 22, new int[]{3, 6, 7, 3}, 15, SoundEvents.ARMOR_EQUIP_IRON,
            1.0F, 0.0F, () -> Ingredient.of(ModItems.STEEL_INGOT.get())),

    FIERY_STEEL("fiery_steel", 22, new int[]{3, 6, 7, 3}, 15, SoundEvents.ARMOR_EQUIP_IRON,
            1.0F, 0.0F, () -> Ingredient.of(ModItems.STEEL_INGOT.get()));
    ...
    public String getName() {
        return CursedCraft.MOD_ID + ":" + this.name;
    }
